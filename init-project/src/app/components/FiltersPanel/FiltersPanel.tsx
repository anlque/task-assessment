...
import {
  SearchParamsOrder,
  SearchParamsSort,
} from "@/app/(posts)/dashboard/types/params";
...
export const FiltersPanel = (props: FiltersPanelProps) => {
  const { className, sort, order, search, onSetSort, onSetOrder, onSetSearch } =
    props;

  return (
    <div
      className={`mb-4 flex space-x-4 items-center bg-gray-100 py-1 px-3 rounded-lg ${className}`}
    >
